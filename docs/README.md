...
Swarm Conductor 文档目录。

| 文件 | 内容 |
|------|------|
| [01-installation.md](01-installation.md) | 系统要求、安装步骤、配置字段说明、AGENTS.md 注入 |
| [02-quickstart.md](02-quickstart.md) | demo/run/bench 命令、编程式 API 示例、多 phase 流程、审批控制 |
